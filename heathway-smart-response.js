...
function detectSentiment(msg) {
    ...
    if (/\b(amazing|brilliant|great|love|wonderful|excellent|fantastic|perfect|thank|thanks|cheers|appreciate|helpful|helpful)\b/.test(msg)) {
        return 'positive';
    }
...
const topics = [
    ...
    // ── Default (lowest weight, always last resort) ──
    {
        id: 'default',
        priority: -1,
        keywords: [],
